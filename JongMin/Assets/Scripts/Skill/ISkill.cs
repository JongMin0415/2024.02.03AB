...
public class DamageEffect : ISkillEffect
{
    ...
    public DamageEffect(int damege)
    {
        Damage = damege;
    }
    ...
    public void Apply(ISkillTarget target)
    {
        if (target is Player player)
        {
            ...
            Debug.Log($"Player took {Damage} damage. Remaining gealth: {player.Health}");
        }
    ...
    public class HealEffect : ISkillEffect
    {
        ...
        public void Apply(ISkillTarget target)
        {
            if (target is Player player)
            {
                ...
                Debug.Log($"Player took {HealAmount} damage. Remaining gealth: {player.Health}");
            }
            else if (target is Enemy enemy)
            {
